    ...
    public void Adicionar(Scanner sc) throws IOException {
        ...
        do {
            ...
            for (Lab i : listP) {
                ...
                Path path = Path.of("E:/Documentos/Workspace - Java/java-in-vscode/Interface Gráfica/Produtos/"
                        + location + ".txt");
                String way = "E:/Documentos/Workspace - Java/java-in-vscode/Interface Gráfica/Produtos/" + location
                        + ".txt";
                for (int c = 0; c < 100; c++) {
                    if (Files.notExists(path)) {
                        ...
                        path = Path.of("E:/Documentos/Workspace - Java/java-in-vscode/Interface Gráfica/Produtos/"
                                + location + ".txt");
                        way = "E:/Documentos/Workspace - Java/java-in-vscode/Interface Gráfica/Produtos/" + location
                                + ".txt";
                    }
